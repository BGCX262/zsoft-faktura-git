--update ims.t_transaction set PAYMENT_METHOD='CASH'
--
--select * from ims.t_transaction
--INSERT INTO t_customer ( ADDRESS, CELL_NUMBER, CITY, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER, POSTAL_CODE) VALUES( 'address', '33333', 'oslo', 'kkk@nn.com', 'Mehdi', 'Zare', '23333', 2222);
--
--INSERT INTO T_RECIEVER (  CELL_NUMBER, CITY, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER, CUSTOMER_ID) VALUES (  '2222', 'tehran', 'ddd@yy.com', 'akbar', 'akbari', '636377', 1);
--INSERT INTO T_RECIEVER (  CELL_NUMBER, CITY, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER, CUSTOMER_ID) VALUES (  '2222', 'tehran', 'ddd@yy.com', 'hamid', 'hasani', '34343', 1);
--
--insert into T_TRANSACTION ( AMOUNT, COMMENTS, CONVERTED_AMOUNT, FROM_CURRENCY, PAYMENT_METHOD, TO_CURRENCY, CUSTOMER_ID, RECIEVER_ID,STATUS) VALUES( 12.1,'comments', 1234, 'NOK', 'BANK_CARD','TOMAN', 1, 1,'SUBMITED');
--insert into T_TRANSACTION ( AMOUNT, COMMENTS, CONVERTED_AMOUNT, FROM_CURRENCY, PAYMENT_METHOD, TO_CURRENCY, CUSTOMER_ID, RECIEVER_ID,STATUS) VALUES( 333.1,'comments', 1234, 'NOK', 'BANK_CARD','TOMAN', 1, 1,'COMPLETED');
