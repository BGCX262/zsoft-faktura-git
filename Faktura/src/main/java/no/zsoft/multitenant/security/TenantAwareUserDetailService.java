...
public class TenantAwareUserDetailService extends JdbcDaoSupport implements UserDetailsService{
    ...
    public TenantAwareUserDetailService() {
    ...
    protected List<UserDetails> loadUsersByUsername(String username) {
        return getJdbcTemplate().query(usersByUsernameQuery, new String[] {username,ThreadLocalContextUtil.getTenantId()}, new RowMapper<UserDetails>() {
    ...
    protected List<GrantedAuthority> loadUserAuthorities(String username) {
        return getJdbcTemplate().query(authoritiesByUsernameQuery, new String[] {username,ThreadLocalContextUtil.getTenantId()}, new RowMapper<GrantedAuthority>() {
